...
\autorficha{Gordo, Jo\~ao Victor Batista}
\autorabr{GORDO, J.V.B}
...
\notaautorizacao{AUTORIZO A REPRODU\c{C}\~AO E DIVULGA\c{C}\~AO TOTAL OU PARCIAL DESTE TRABALHO, POR QUALQUER MEIO CONVENCIONAL OU ELETR\^ONICO PARA 
